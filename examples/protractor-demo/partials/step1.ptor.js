...
module.exports = ((config, data) => {
    ...
    describe('Protractor Demo App', () => {
        ...
        it('should add one and two', () => {
            ...
            element(by.id(`gobutton`)).click().then(null, (err) => fail(err + "\ncommand: " + `click|id=gobutton|`));
            ...
            element(by.css(`.container div .form-inline h2`)).getText().then((_value) => {
        ...
        it('should verify that state is cleared', () => {

            element(by.css(`[ng-model='first']`)).getAttribute("value").then((_value) => {
                expect(_value).toEqual('',`assertValue|css=[ng-model='first']|`);
                element(by.css(`[ng-model='second']`)).getAttribute("value").then((_value) => {
