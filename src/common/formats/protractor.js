...
ProtractorFormatter.prototype = Object.create(BaseFormatter.prototype);

ProtractorFormatter.prototype.parse = function (content) {
...
ProtractorFormatter.prototype.stringify = function (testCase) {
  if (!this.formatter) {
  ...
  header += 'var ' + this.variableName + ' = ' + angular.toJson(testCase, true) + ';' + this.formatter.endOfLine;
...
module.exports = new ProtractorFormatter();